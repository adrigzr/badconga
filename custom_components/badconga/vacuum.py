...
from .app.const import FAN_MODE_NONE, FAN_MODE_ECO, FAN_MODE_NORMAL, FAN_MODE_TURBO, ModelName
...
class CongaVacuum(VacuumEntity):
    ...
    def state_attributes(self):
        ...
        data['model'] = ModelName[self.instance.client.device.model] if (
            self.instance.client.device.model in ModelName) else (
